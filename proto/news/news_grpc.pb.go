...
const (
	...
	NewsService_GetNewsList_FullMethodName = "/news.NewsService/GetNewsList"
...
type NewsServiceClient interface {
	...
	GetNewsList(ctx context.Context, in *GetNewsListRequest, opts ...grpc.CallOption) (*GetNewsListResponse, error)
...
func (c *newsServiceClient) GetNewsList(ctx context.Context, in *GetNewsListRequest, opts ...grpc.CallOption) (*GetNewsListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetNewsListResponse)
	err := c.cc.Invoke(ctx, NewsService_GetNewsList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NewsServiceServer interface {
	...
	GetNewsList(context.Context, *GetNewsListRequest) (*GetNewsListResponse, error)
...
func (UnimplementedNewsServiceServer) GetNewsList(context.Context, *GetNewsListRequest) (*GetNewsListResponse, error) {
